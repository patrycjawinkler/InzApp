...
class ChosenListActivity : AppCompatActivity() {
    ...
    private val authStateListener = FirebaseAuth.AuthStateListener { firebaseAuth ->
        if(firebaseAuth.currentUser == null) {
            val intent = Intent(this@ChosenListActivity, LoginActivity::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.chosen_recipes_list)
        ...
        navigationView.apply{
            ...
            setShoppingListAction {
                val intent = Intent(this@ChosenListActivity, ShoppingListActivity::class.java)
                startActivity(intent)
            }
            setRandomRecipeAction {
                val intent = Intent(this@ChosenListActivity, RandomRecipeActivity::class.java)
                startActivity(intent)
            }
            setGiveRecipeAction {
                val intent = Intent(this@ChosenListActivity, FilterRecipesActivity::class.java)
                startActivity(intent)
            }
            setFavoriteRecipesAction {
                val intent = Intent(this@ChosenListActivity, FavoriteListActivity::class.java)
                startActivity(intent)
            }
            setChosenRecipesAction {
                val intent = Intent(this@ChosenListActivity, ChosenListActivity::class.java)
                startActivity(intent)
            }
        }
        ...
        val recipeRecycleView = findViewById<RecyclerView>(R.id.chosen_recipes_recycle_view)
        recipeRecycleView.apply {
            adapter = recipeRecycleAdapter
            layoutManager = LinearLayoutManager(this@ChosenListActivity)
            setHasFixedSize(true)
        }

        //Pobieranie listy przepisów z bazy danych
        recipeViewModel = ViewModelProviders.of(this@ChosenListActivity).get(RecipeViewModel::class.java)
        recipeViewModel.getAllChosenUserRecipes()

        recipeViewModel.currentRecipeList.observe(this@ChosenListActivity, Observer {
